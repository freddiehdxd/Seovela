...
<div class="seovela-image-seo-page">
	...
	<div class="seovela-imgseo-header">
		<div class="seovela-imgseo-header-left">
			...
			<div class="seovela-imgseo-header-text">
				<h1><?php esc_html_e( 'Image SEO', 'seovela' ); ?> <span class="seovela-imgseo-badge"><?php esc_html_e( 'Pro', 'seovela' ); ?></span></h1>
				<p><?php esc_html_e( 'Optimize images with smart alt text, titles, WebP conversion & more', 'seovela' ); ?></p>
			</div>
		</div>
	...
	<div class="seovela-imgseo-container">
		...
		<div class="seovela-imgseo-progress-container" id="progress-container" style="display: none;">
			...
			<p class="seovela-imgseo-progress-text" id="progress-text"><?php esc_html_e( 'Scanning...', 'seovela' ); ?></p>
		</div>

		<!-- Navigation Tabs -->
		<div class="seovela-imgseo-tabs">
			<button type="button" class="seovela-imgseo-tab active" data-tab="images"><?php esc_html_e( 'Images', 'seovela' ); ?></button>
			<button type="button" class="seovela-imgseo-tab" data-tab="settings"><?php esc_html_e( 'Auto-Fill Settings', 'seovela' ); ?></button>
			<button type="button" class="seovela-imgseo-tab" data-tab="webp"><?php esc_html_e( 'WebP Conversion', 'seovela' ); ?></button>
			<button type="button" class="seovela-imgseo-tab" data-tab="variables"><?php esc_html_e( 'Variables', 'seovela' ); ?></button>
	</div>
			...
			<div class="seovela-imgseo-section">
				<div class="seovela-imgseo-toolbar">
					<div class="seovela-imgseo-toolbar-left">
						<select id="filter-images" class="seovela-imgseo-select">
							<option value="all"><?php esc_html_e( 'All Images', 'seovela' ); ?></option>
							<option value="not_scanned"><?php esc_html_e( 'Not Scanned', 'seovela' ); ?></option>
							<option value="scanned"><?php esc_html_e( 'Scanned', 'seovela' ); ?></option>
							<option value="issues"><?php esc_html_e( 'With Issues', 'seovela' ); ?></option>
							<option value="missing_alt"><?php esc_html_e( 'Missing Alt Text', 'seovela' ); ?></option>
							<option value="missing_title"><?php esc_html_e( 'Missing Title', 'seovela' ); ?></option>
							<option value="missing_caption"><?php esc_html_e( 'Missing Caption', 'seovela' ); ?></option>
							<option value="missing_description"><?php esc_html_e( 'Missing Description', 'seovela' ); ?></option>
					<option value="oversized"><?php esc_html_e( 'Oversized Files', 'seovela' ); ?></option>
					<option value="poor_filename"><?php esc_html_e( 'Poor Filenames', 'seovela' ); ?></option>
							<option value="no_webp"><?php esc_html_e( 'No WebP Version', 'seovela' ); ?></option>
							<option value="has_webp"><?php esc_html_e( 'Has WebP', 'seovela' ); ?></option>
				</select>
						<div class="seovela-imgseo-search">
							<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
								<path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
							</svg>
							<input type="text" id="search-images" placeholder="<?php esc_attr_e( 'Search images...', 'seovela' ); ?>">
						</div>
			</div>
					<div class="seovela-imgseo-toolbar-right">
						<div class="seovela-imgseo-bulk-actions">
							<select id="bulk-action" class="seovela-imgseo-select">
								<option value=""><?php esc_html_e( 'Bulk Actions', 'seovela' ); ?></option>
								<option value="apply_alt"><?php esc_html_e( 'Apply Alt Template', 'seovela' ); ?></option>
								<option value="apply_title"><?php esc_html_e( 'Apply Title Template', 'seovela' ); ?></option>
								<option value="apply_caption"><?php esc_html_e( 'Apply Caption Template', 'seovela' ); ?></option>
								<option value="apply_description"><?php esc_html_e( 'Apply Description Template', 'seovela' ); ?></option>
								<option value="apply_all"><?php esc_html_e( 'Apply All Templates', 'seovela' ); ?></option>
								<option value="convert_webp"><?php esc_html_e( 'Convert to WebP', 'seovela' ); ?></option>
							</select>
							<button type="button" class="seovela-imgseo-btn seovela-imgseo-btn-secondary" id="apply-bulk-action">
								<?php esc_html_e( 'Apply', 'seovela' ); ?>
				</button>
			</div>
		</div>
				</div>
					...
					<thead>
						<tr>
							<th class="check-column"><input type="checkbox" id="select-all-images"></th>
								<th class="image-column"><?php esc_html_e( 'Image', 'seovela' ); ?></th>
								<th class="filename-column"><?php esc_html_e( 'File Name', 'seovela' ); ?></th>
								<th class="alt-column"><?php esc_html_e( 'Alt Text', 'seovela' ); ?></th>
								<th class="title-column"><?php esc_html_e( 'Title', 'seovela' ); ?></th>
								<th class="status-column"><?php esc_html_e( 'Status', 'seovela' ); ?></th>
								<th class="size-column"><?php esc_html_e( 'Size', 'seovela' ); ?></th>
								<th class="actions-column"><?php esc_html_e( 'Actions', 'seovela' ); ?></th>
						</tr>
					</thead>
							...
							<tr class="loading-row">
								<td colspan="8">
									<div class="seovela-imgseo-loading">
										...
										<span><?php esc_html_e( 'Loading images...', 'seovela' ); ?></span>
									</div>
								</td>
							</tr>
						</tbody>
				...
				<div class="seovela-imgseo-pagination" id="pagination">
					...
					<div class="pagination-buttons">
						<button type="button" class="seovela-imgseo-btn seovela-imgseo-btn-secondary" id="prev-page" disabled><?php esc_html_e( 'Previous', 'seovela' ); ?></button>
						<button type="button" class="seovela-imgseo-btn seovela-imgseo-btn-secondary" id="next-page"><?php esc_html_e( 'Next', 'seovela' ); ?></button>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="seovela-imgseo-tab-content" id="tab-settings">
			<form id="settings-form">
				...
				<div class="seovela-imgseo-section">
					<div class="seovela-imgseo-section-header">
						<div class="seovela-imgseo-section-title">
							...
							<h2><?php esc_html_e( 'General Settings', 'seovela' ); ?></h2>
						</div>
					</div>
					...
					<div class="seovela-imgseo-grid two-col">
						<div class="seovela-imgseo-field">
							<label class="seovela-imgseo-toggle">
								...
								<span class="toggle-label"><?php esc_html_e( 'Enable Image SEO Module', 'seovela' ); ?></span>
							</label>
						</div>
						<div class="seovela-imgseo-field">
							<label class="seovela-imgseo-toggle">
								...
								<span class="toggle-slider"></span>
								<span class="toggle-label"><?php esc_html_e( 'Auto-process on Upload', 'seovela' ); ?></span>
							</label>
						</div>
					</div>
					...
					<div class="seovela-imgseo-grid two-col">
						<div class="seovela-imgseo-field">
							<label><?php esc_html_e( 'File Size Threshold (KB)', 'seovela' ); ?></label>
							...
							<p class="field-hint"><?php esc_html_e( 'Images larger than this will be flagged as oversized', 'seovela' ); ?></p>
						</div>
						<div class="seovela-imgseo-field">
							<label><?php esc_html_e( 'Separator Character', 'seovela' ); ?></label>
							<input type="text" name="separator" value="<?php echo esc_attr( $settings['separator'] ); ?>" class="seovela-imgseo-input">
							<p class="field-hint"><?php esc_html_e( 'Used in the %separator% variable', 'seovela' ); ?></p>
						</div>
					</div>
				</div>
				...
				<div class="seovela-imgseo-section">
					<div class="seovela-imgseo-section-header">
						<div class="seovela-imgseo-section-title">
							...
							<h2><?php esc_html_e( 'Alt Text Settings', 'seovela' ); ?></h2>
						</div>
						<span class="seovela-imgseo-badge-small green"><?php esc_html_e( 'SEO Critical', 'seovela' ); ?></span>
					</div>

					<div class="seovela-imgseo-grid two-col">
						<div class="seovela-imgseo-field">
							<label><?php esc_html_e( 'Alt Text Template', 'seovela' ); ?></label>
							...
							<p class="field-hint"><?php esc_html_e( 'Use variables like %file_name_raw%, %post_title%, %site_title%', 'seovela' ); ?></p>
						</div>
						<div class="seovela-imgseo-field">
							<label><?php esc_html_e( 'Alt Text Casing', 'seovela' ); ?></label>
					...
					<div class="seovela-imgseo-grid two-col">
						<div class="seovela-imgseo-field">
							<label class="seovela-imgseo-toggle">
								...
								<span class="toggle-slider"></span>
								<span class="toggle-label"><?php esc_html_e( 'Add missing alt text on upload', 'seovela' ); ?></span>
							</label>
						</div>
						<div class="seovela-imgseo-field">
							<label class="seovela-imgseo-toggle">
								...
								<span class="toggle-slider"></span>
								<span class="toggle-label"><?php esc_html_e( 'Overwrite existing alt text', 'seovela' ); ?></span>
							</label>
						</div>
					</div>
				</div>
				...
				<div class="seovela-imgseo-section">
					...
					<div class="seovela-imgseo-grid two-col">
						<div class="seovela-imgseo-field">
							<label><?php esc_html_e( 'Title Template', 'seovela' ); ?></label>
							<div class="seovela-imgseo-input-with-vars">
						...
						<div class="seovela-imgseo-field">
							<label><?php esc_html_e( 'Title Casing', 'seovela' ); ?></label>
					...
					<div class="seovela-imgseo-grid two-col">
						<div class="seovela-imgseo-field">
							<label class="seovela-imgseo-toggle">
								...
								<span class="toggle-slider"></span>
								<span class="toggle-label"><?php esc_html_e( 'Add missing title on upload', 'seovela' ); ?></span>
							</label>
						</div>
						<div class="seovela-imgseo-field">
							<label class="seovela-imgseo-toggle">
								...
								<span class="toggle-slider"></span>
								<span class="toggle-label"><?php esc_html_e( 'Overwrite existing title', 'seovela' ); ?></span>
							</label>
						</div>
					</div>
				</div>
				...
				<div class="seovela-imgseo-section">
					<div class="seovela-imgseo-section-header">
						<div class="seovela-imgseo-section-title">
							...
							<h2><?php esc_html_e( 'Caption Settings', 'seovela' ); ?></h2>
						</div>
					</div>

					<div class="seovela-imgseo-grid two-col">
						<div class="seovela-imgseo-field">
							<label><?php esc_html_e( 'Caption Template', 'seovela' ); ?></label>
							<div class="seovela-imgseo-input-with-vars">
								<input type="text" name="caption_template" value="<?php echo esc_attr( $settings['caption_template'] ); ?>" class="seovela-imgseo-input" placeholder="<?php esc_attr_e( 'Leave empty to skip', 'seovela' ); ?>">
						...
						<div class="seovela-imgseo-field">
							<label><?php esc_html_e( 'Caption Casing', 'seovela' ); ?></label>
					...
					<div class="seovela-imgseo-grid two-col">
						<div class="seovela-imgseo-field">
							<label class="seovela-imgseo-toggle">
								...
								<span class="toggle-slider"></span>
								<span class="toggle-label"><?php esc_html_e( 'Add missing caption on upload', 'seovela' ); ?></span>
							</label>
						</div>
						<div class="seovela-imgseo-field">
							<label class="seovela-imgseo-toggle">
								...
								<span class="toggle-slider"></span>
								<span class="toggle-label"><?php esc_html_e( 'Overwrite existing caption', 'seovela' ); ?></span>
							</label>
						</div>
					</div>
				</div>
				...
				<div class="seovela-imgseo-section">
					<div class="seovela-imgseo-section-header">
						<div class="seovela-imgseo-section-title">
							...
							<h2><?php esc_html_e( 'Description Settings', 'seovela' ); ?></h2>
						</div>
					</div>

					<div class="seovela-imgseo-field">
						<label><?php esc_html_e( 'Description Template', 'seovela' ); ?></label>
						<div class="seovela-imgseo-input-with-vars">
							<textarea name="description_template" class="seovela-imgseo-textarea" rows="3" placeholder="<?php esc_attr_e( 'Leave empty to skip', 'seovela' ); ?>"><?php echo esc_textarea( $settings['description_template'] ); ?></textarea>
					...
					<div class="seovela-imgseo-grid three-col">
						<div class="seovela-imgseo-field">
							<label><?php esc_html_e( 'Description Casing', 'seovela' ); ?></label>
						...
						<div class="seovela-imgseo-field">
							<label class="seovela-imgseo-toggle">
								...
								<span class="toggle-slider"></span>
								<span class="toggle-label"><?php esc_html_e( 'Add missing', 'seovela' ); ?></span>
							</label>
						</div>
						<div class="seovela-imgseo-field">
							<label class="seovela-imgseo-toggle">
								...
								<span class="toggle-slider"></span>
								<span class="toggle-label"><?php esc_html_e( 'Overwrite existing', 'seovela' ); ?></span>
							</label>
						</div>
					</div>
				</div>
				...
				<div class="seovela-imgseo-form-actions">
					<button type="submit" class="seovela-imgseo-btn seovela-imgseo-btn-primary" id="save-settings">
						...
						<?php esc_html_e( 'Save Settings', 'seovela' ); ?>
					</button>
				</div>
			</form>
		</div>
			...
			<div class="seovela-imgseo-section">
				<div class="seovela-imgseo-section-header">
					<div class="seovela-imgseo-section-title">
						...
						<h2><?php esc_html_e( 'WebP Conversion', 'seovela' ); ?></h2>
					</div>
				</div>
				...
				<div class="seovela-imgseo-library-status">
					<div class="library-card <?php echo $libraries['imagick']['available'] && $libraries['imagick']['webp_support'] ? 'available' : 'unavailable'; ?>">
						...
						<div class="library-info">
							...
							<?php else : ?>
								<p><?php esc_html_e( 'Not installed', 'seovela' ); ?></p>
								<span class="library-badge error"><?php esc_html_e( 'Unavailable', 'seovela' ); ?></span>
							<?php endif; ?>
						</div>
					</div>
				...
				<form id="webp-settings-form">
					<div class="seovela-imgseo-grid two-col">
						<div class="seovela-imgseo-field">
							<label class="seovela-imgseo-toggle">
								...
								<span class="toggle-slider"></span>
								<span class="toggle-label"><?php esc_html_e( 'Enable WebP Conversion', 'seovela' ); ?></span>
							</label>
						</div>
						<div class="seovela-imgseo-field">
							<label class="seovela-imgseo-toggle">
								...
								<span class="toggle-slider"></span>
								<span class="toggle-label"><?php esc_html_e( 'Auto-convert on Upload', 'seovela' ); ?></span>
							</label>
						</div>
					</div>
					...
					<div class="seovela-imgseo-grid two-col">
						<div class="seovela-imgseo-field">
							<label><?php esc_html_e( 'Preferred Library', 'seovela' ); ?></label>
							<select name="webp_library" class="seovela-imgseo-select">
								<option value="auto" <?php selected( $settings['webp_library'], 'auto' ); ?>><?php esc_html_e( 'Auto (Imagick > GD)', 'seovela' ); ?></option>
						...
						<div class="seovela-imgseo-field">
							<label><?php esc_html_e( 'WebP Quality', 'seovela' ); ?></label>
					...
					<div class="seovela-imgseo-field" style="margin-top: 20px;">
						<label class="seovela-imgseo-toggle">
							...
							<span class="toggle-slider"></span>
							<span class="toggle-label"><?php esc_html_e( 'Replace original with WebP (delete original)', 'seovela' ); ?></span>
						</label>
						<p class="field-description"><?php esc_html_e( 'When enabled, the original image will be deleted and replaced with the WebP version. This saves disk space but removes the original file permanently.', 'seovela' ); ?></p>
					</div>
					...
					<div class="seovela-imgseo-warning-box" id="replace-original-warning" style="display: <?php echo ! empty( $settings['replace_original'] ) ? 'flex' : 'none'; ?>;">
						...
						<div>
							<strong><?php esc_html_e( 'Warning:', 'seovela' ); ?></strong>
							<p><?php esc_html_e( 'This action is irreversible! Original files will be permanently deleted. Make sure you have backups before enabling this option.', 'seovela' ); ?></p>
						</div>
					</div>
			...
			<div class="seovela-imgseo-section">
				<div class="seovela-imgseo-section-header">
					<div class="seovela-imgseo-section-title">
						...
						<h2><?php esc_html_e( 'WebP Serving', 'seovela' ); ?></h2>
					</div>
					<p class="seovela-imgseo-section-desc"><?php esc_html_e( 'Automatically serve WebP images to browsers that support them.', 'seovela' ); ?></p>
				</div>
				...
				<form id="webp-serving-form">
					<div class="seovela-imgseo-field">
						<label class="seovela-imgseo-toggle">
							...
							<span class="toggle-slider"></span>
							<span class="toggle-label"><?php esc_html_e( 'Enable WebP Serving', 'seovela' ); ?></span>
						</label>
						<p class="field-description"><?php esc_html_e( 'When enabled, WebP versions will be served to browsers that support them.', 'seovela' ); ?></p>
					</div>

					<div class="seovela-imgseo-field">
						<label><?php esc_html_e( 'Serving Method', 'seovela' ); ?></label>
						<div class="seovela-imgseo-radio-group">
							<label class="seovela-imgseo-radio">
								...
								<span class="radio-label">
									<strong><?php esc_html_e( 'PHP Method', 'seovela' ); ?></strong>
									<span class="radio-desc"><?php esc_html_e( 'Filter image URLs through WordPress. Works on all servers.', 'seovela' ); ?></span>
								</span>
							</label>
							<label class="seovela-imgseo-radio">
								...
								<span class="radio-custom"></span>
								<span class="radio-label">
									<strong><?php esc_html_e( '.htaccess Rewrite', 'seovela' ); ?></strong>
									<span class="radio-desc"><?php esc_html_e( 'Server-level rewrite (Apache only). Faster but requires mod_rewrite.', 'seovela' ); ?></span>
								</span>
							</label>
						</div>
					</div>
					...
					<div class="seovela-imgseo-info-box">
						...
						<div>
							<strong><?php esc_html_e( 'How it works:', 'seovela' ); ?></strong>
							<ul>
								<li><?php esc_html_e( 'WebP files are stored alongside original images (e.g., image.jpg → image.webp)', 'seovela' ); ?></li>
								<li><?php esc_html_e( 'Browser support is auto-detected via Accept header', 'seovela' ); ?></li>
								<li><?php esc_html_e( 'Original files are preserved as fallback for older browsers', 'seovela' ); ?></li>
							</ul>
						</div>
					</div>
				</form>
			...
			<div class="seovela-imgseo-section">
				<div class="seovela-imgseo-section-header">
					<div class="seovela-imgseo-section-title">
						...
						<h2><?php esc_html_e( 'Bulk Convert', 'seovela' ); ?></h2>
					</div>
				</div>
				...
				<div class="seovela-imgseo-conversion-actions">
					...
					<button type="button" class="seovela-imgseo-btn seovela-imgseo-btn-primary seovela-imgseo-btn-large" id="convert-all-webp" <?php disabled( $stats['convertible'] === 0 ); ?>>
						...
						<?php esc_html_e( 'Convert All to WebP', 'seovela' ); ?>
					</button>
				</div>
			</div>
		</div>
			...
			<div class="seovela-imgseo-section">
				<div class="seovela-imgseo-section-header">
					<div class="seovela-imgseo-section-title">
						...
						<h2><?php esc_html_e( 'Available Variables', 'seovela' ); ?></h2>
					</div>
				</div>

				<p class="seovela-imgseo-section-description">
					<?php esc_html_e( 'Use these variables in your templates to dynamically generate alt text, titles, captions, and descriptions. Click on any variable to copy it to your clipboard.', 'seovela' ); ?>
				</p>
							...
							<div class="variables-list">
								<?php foreach ( $cat_variables as $var_key => $var_data ) : ?>
									<div class="variable-item" data-variable="%<?php echo esc_attr( $var_key ); ?>%">
										...
										<button type="button" class="copy-variable-btn" title="<?php esc_attr_e( 'Copy to clipboard', 'seovela' ); ?>">
											<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
				...
				<div class="seovela-imgseo-examples">
					<h3><?php esc_html_e( 'Example Templates', 'seovela' ); ?></h3>
					<div class="examples-grid">
						<div class="example-card">
							<h4><?php esc_html_e( 'Basic Alt Text', 'seovela' ); ?></h4>
							<code>%file_name_raw%</code>
							<p><?php esc_html_e( 'Simply uses the filename, cleaned up', 'seovela' ); ?></p>
						</div>
						<div class="example-card">
							<h4><?php esc_html_e( 'Context-Aware Alt', 'seovela' ); ?></h4>
							<code>%file_name_raw% %separator% %post_title%</code>
							<p><?php esc_html_e( 'Combines image name with parent post title', 'seovela' ); ?></p>
						</div>
						<div class="example-card">
							<h4><?php esc_html_e( 'Brand Focused', 'seovela' ); ?></h4>
							<code>%file_name_raw% | %site_title%</code>
							<p><?php esc_html_e( 'Adds your site name for brand visibility', 'seovela' ); ?></p>
						</div>
						<div class="example-card">
							<h4><?php esc_html_e( 'Numbered Series', 'seovela' ); ?></h4>
							<code>%post_title% Image %counter%</code>
							<p><?php esc_html_e( 'Perfect for galleries with sequential numbering', 'seovela' ); ?></p>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="seovela-imgseo-modal" id="variable-picker-modal" style="display: none;">
		...
		<div class="modal-content">
			<div class="modal-header">
				<h3><?php esc_html_e( 'Insert Variable', 'seovela' ); ?></h3>
				<button type="button" class="modal-close">&times;</button>
			</div>
			<div class="modal-body">
				<div class="modal-search">
					<input type="text" id="variable-search" placeholder="<?php esc_attr_e( 'Search variables...', 'seovela' ); ?>">
				</div>
	...
	<div class="seovela-imgseo-modal" id="edit-image-modal" style="display: none;">
		...
		<div class="modal-content modal-large">
			<div class="modal-header">
				<h3><?php esc_html_e( 'Edit Image Attributes', 'seovela' ); ?></h3>
				<button type="button" class="modal-close">&times;</button>
			</div>
			<div class="modal-body">
				...
				<form id="edit-image-form">
					...
					<div class="seovela-imgseo-field">
						<label><?php esc_html_e( 'Alt Text', 'seovela' ); ?></label>
						<div class="input-with-action">
							<input type="text" name="alt" id="edit-image-alt" class="seovela-imgseo-input">
							<button type="button" class="apply-template-btn" data-attribute="alt" title="<?php esc_attr_e( 'Apply template', 'seovela' ); ?>">
								<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
									<path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09Z" />
								</svg>
							</button>
					...
					<div class="seovela-imgseo-field">
						<label><?php esc_html_e( 'Title', 'seovela' ); ?></label>
						<div class="input-with-action">
							<input type="text" name="title" id="edit-image-title" class="seovela-imgseo-input">
							<button type="button" class="apply-template-btn" data-attribute="title" title="<?php esc_attr_e( 'Apply template', 'seovela' ); ?>">
								<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
									<path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09Z" />
								</svg>
							</button>
					...
					<div class="seovela-imgseo-field">
						<label><?php esc_html_e( 'Caption', 'seovela' ); ?></label>
						<div class="input-with-action">
							<input type="text" name="caption" id="edit-image-caption" class="seovela-imgseo-input">
							<button type="button" class="apply-template-btn" data-attribute="caption" title="<?php esc_attr_e( 'Apply template', 'seovela' ); ?>">
								<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
									<path stroke-linecap="round" stroke-linejoin="round" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09Z" />
								</svg>
							</button>
					...
					<div class="seovela-imgseo-field">
						<label><?php esc_html_e( 'Description', 'seovela' ); ?></label>
						<textarea name="description" id="edit-image-description" class="seovela-imgseo-textarea" rows="3"></textarea>
					</div>
				</form>
			</div>
			<div class="modal-footer">
				<button type="button" class="seovela-imgseo-btn seovela-imgseo-btn-secondary modal-close-btn"><?php esc_html_e( 'Cancel', 'seovela' ); ?></button>
				<button type="button" class="seovela-imgseo-btn seovela-imgseo-btn-primary" id="save-image-edit"><?php esc_html_e( 'Save Changes', 'seovela' ); ?></button>
			</div>
		</div>
	</div>
